...
**Design components** produced from specs.

- `3-design/figma/` — the Figma file, design origin and source of truth for
  appearance.

Flutter app, not a web component library — the scaffold's React/Vue mirror
targets were dropped; components are implemented directly as Flutter widgets
in `lib/`, not mirrored into `3-design/`.
